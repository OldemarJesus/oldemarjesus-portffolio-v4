...
export default function App() {
  ...
  return (
    <div className="bg-gray-900 min-h-screen pb-48 text-white">
      ...
      <nav onClick={() => setMenuOpen(state => !state)} className={`hidden ${menuOpen && "max-sm:flex"} flex-col items-center w-screen h-screen absolute bg-gray-900 bg-opacity-95 pt-2`}>
